...
export class Tab2Page {
  ...
  exibirSerie(Serie: ISerie){
    ...
    this.router.navigate(['Serie-detalhe'], navigationExtras); //chama o navigate e pega a q vc vai abrir com os dados do Serie, por isso navigationExtras (ele ta sendo declarado e define um state parametro para a navegação) 
  }
